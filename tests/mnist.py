#https://raw.githubusercontent.com/datapythonista/mnist/master/mnist/__init__.py
...
def train_images():
    ...
    """
    return download_and_parse_mnist_file('train-images-idx3-ubyte.gz', 'MNIST_data')
