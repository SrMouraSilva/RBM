...
class RBMCFSVMModel(OtherModel):
    ...
    def __init__(self, rbm_class):
        super().__init__()
        self._models_path = [
            f'../results/model/kfold={i}+kfold-intern=0+batch_size=10+class={rbm_class.__class__.__name__}+visible_size=702+hidden_size=1000+regularization=NoRegularization-0.0+learning_rate=ConstantLearningRate-0.2+sampling_method=CD-1+momentum=1/rbm.ckpt'
